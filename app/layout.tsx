...
export const metadata: Metadata = {
  ...
  description: 'Premium custom cabinetry crafted in Richmond, BC. Specializing in kitchen cabinets, bathroom vanities, built-ins, and custom storage solutions. Expert craftsmanship meets contemporary design.',
  keywords: [
    'custom cabinetry',
  ...
  openGraph: {
    ...
    description: 'Premium custom cabinetry crafted in Richmond, BC. Specializing in kitchen cabinets, bathroom vanities, built-ins, and custom storage solutions.',
    images: [
      {
  ...
  twitter: {
    ...
    description: 'Premium custom cabinetry crafted in Richmond, BC. Expert craftsmanship meets contemporary design.',
