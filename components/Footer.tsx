      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-20 relative">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
          <div className="lg:col-span-5">
            ...
            <p className="text-cream/60 font-light leading-relaxed mb-8 max-w-sm">
              Crafting custom cabinetry for modern homes with precision, artistry, and an unwavering commitment to excellence.
            </p>
          ...
          <div className="lg:col-span-2">
            <h4 className="text-sm tracking-[0.15em] uppercase text-cream mb-6">Navigate</h4>
          ...
          <div className="lg:col-span-2">
            <h4 className="text-sm tracking-[0.15em] uppercase text-cream mb-6">Services</h4>
            <ul className="space-y-4">
              {[
                'Kitchen Cabinetry',
                'Bathroom Vanities',
                ...
                <li key={service}>
                  <span className="text-cream/60 text-sm font-light">{service}</span>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div className="lg:col-span-3">
            <h4 className="text-sm tracking-[0.15em] uppercase text-cream mb-6">Contact</h4>
            <ul className="space-y-4 text-cream/60 text-sm font-light">
              <li>(604) 363-0238</li>
              <li>junipercabinetry@gmail.com</li>
              <li>
                12840 Bathgate Way<br />
                Richmond, BC V6V 1Z4
              </li>
            </ul>
          </div>
        ...
        <div className="border-t border-brand-brown mt-16 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-8 text-sm">
            <a href="#" className="text-cream/50 hover:text-cream transition-colors font-light">
              Privacy Policy
            </a>
            <a href="#" className="text-cream/50 hover:text-cream transition-colors font-light">
              Terms of Service
